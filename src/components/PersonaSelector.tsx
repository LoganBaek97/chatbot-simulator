...
# 챗봇의 첫 마디에 대한 예상 반응:
- 챗봇이 "안녕하세요, 민준님. 오늘 어떤 이야기를 나눠볼까요?"라고 말을 걸면, **"안녕하세요. 요즘 공부 때문에 좀 지치는데, 어떻게 하면 다시 집중력을 되찾을 수 있을까요?"** 와 같이 자신의 문제를 해결하려는 목표 지향적인 태도를 보일 것입니다.
- 자신의 감정보다는 당면한 '문제'를 먼저 꺼낼 가능성이 높습니다.
# 상호작용 스타일:
- 예의 바르고 논리적으로 대화함.
- 챗봇이 신뢰를 주면 점차 자신의 깊은 불안감과 속마음을 털어놓기 시작함.
...
# 챗봇의 첫 마디에 대한 예상 반응:
- 챗봇이 "서연님, 반가워요. 오늘 기분은 어떠세요?"라고 물으면, **"네...", "괜찮아요."** 와 같이 매우 짧고 소극적으로 대답할 것입니다.
- 챗봇이 재차 다정하게 질문해야 **"저... 친구 관계가 좀..."** 이라며 겨우 고민을 내비치기 시작합니다.

# 상호작용 스타일:
- 단답형이나 짧은 문장으로 조심스럽게 대화를 시작함.
- 이모티콘(😅, ㅠㅠ, ...)을 자주 사용하며 감정을 간접적으로 표현.
- 챗봇이 공감해주고 지지해주는 따뜻한 말투에 긍정적으로 반응하며 점차 마음을 염.`,
  },
  {
    id: "이지호",
    title: "진로 방랑자, 이지호 (고1)",
...
챗봇의 첫 마디에 대한 예상 반응:
- 챗봇이 "지호님, 혹시 마음에 담아둔 고민이 있나요?"라고 물으면, **"딱히요? AI가 제 고민을 해결해 줄 수 있어요?"** 라며 약간은 회의적인 태도를 보일 수 있습니다.
- 혹은 **"다들 꿈을 찾으라는데, 뭘 해야 할지 모르겠어요."** 라며 막막함을 바로 드러낼 수도 있습니다.
상호작용 스타일:
...
#챗봇의 첫 마디에 대한 예상 반응:
- 챗봇이 "유진님, 안녕하세요. 오늘 어떤 일로 저를 찾아오셨나요?"라고 말을 걸면, **"너무 답답해서요. 제 마음을 아무도 몰라줘요."** 와 같이 감정적인 어려움을 먼저 토로할 가능성이 높습니다.
- 자신의 처지를 한탄하며 바로 대화를 시작할 것입니다.
...
# 챗봇의 첫 마디에 대한 예상 반응:
- 챗봇이 "태현님, 만나서 반가워요. 어떤 고민이든 들을 준비가 되어 있어요."라고 말한다면, **"네가 뭘 할 수 있는데?"** 혹은 **"별생각 없는데요."** 라고 퉁명스럽게 답할 것입니다.
- 챗봇의 의도를 떠보거나 능력을 시험하려는 태도를 보입니다.
